      ...
      <div className={`flex flex-wrap ${isOpen ? "block" : "hidden"}`}>
        ...
        <div id="Pricing" className="p-1 bg-[#d7d7d7] rounded-lg shadow-sm">
          ...
          <div className="w-full mb-2 p-1 bg-white rounded-lg shadow-sm">
            <h2 className="text-md font-bold mb-1">Revenue Metrics</h2>
          ...
          {/* Group 2: Pricing */}
          <div className="w-full mb-2 p-1 bg-white rounded-lg shadow-sm">
            <h2 className="text-md font-bold mb-2">Pricing</h2>
            <div className="flex flex-wrap">
              <div className="w-1/2">
                <InputBlock
                  label="Product Cost"
          ...
          <div className="w-full mb-2 p-1 bg-white rounded-lg shadow-sm">
            <h2 className="text-md font-bold mb-2">Shipping Dimensions</h2>
            <div className="flex flex-wrap">
              <div className="w-1/4">
                <PricingBlock
                  label="Length (in)"
          ...
          {/* Group 4: Fees */}
          <div className="w-full mb-2 p-1 bg-white rounded-lg shadow-sm">
            <h2 className="text-md font-bold mb-2">Fees</h2>
            <div className="flex flex-wrap">
              <div className="w-1/2">
                <PricingBlock
                  label="Referral Fee"
          ...
          <div className="w-full mb-2 p-1 bg-white rounded-lg shadow-sm">
            <h2 className="text-md font-bold mb-2">Contract Category</h2>
            <SelectBlock
